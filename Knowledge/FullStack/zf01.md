...
var f = new Fn
f.getX()  // -> 相当于console.log(f.x) -> 100
f.__proto__.getX()  // -> 相当于console.log(f.__proto__.x) -> undefined
f.getY()  // -> 200
...
![prototype-chain](http://ofx24fene.bkt.clouddn.com//img/blog/prototype-china%C2%8B.svg)
